...
def predict(epochs, teacher_forcing_prob):
    ...
    # model.load_weights('model/bigthrush/320/variables/variables')
    # model = keras.models.load_model('model/bigthrush/320/')
    model.load_weights(MODEL_PATH + '/bigthrush/300/variables/variables')
    print("model loaded...")
